 ...
 */
 ...
 {
	 /*位置式PID-电机1*/
	 PID.MotorA_Velocity_Kp=25; 
	 PID.MotorA_Velocity_Ki=10.0;
	 PID.MotorA_Velocity_Kd=10.0;
	 /*位置式PID-电机2*/
	 PID.MotorB_Velocity_Kp=25; 
	 PID.MotorB_Velocity_Ki=10;
	 PID.MotorB_Velocity_Kd=10;
 }
