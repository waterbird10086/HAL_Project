...
{
	uint32_t off=0,off90 = 0,off180 = 0;
//	IIC_Init();
	pca_write(pca_mode1,0x0);
	pca_setfreq(hz);//设置PWM频率
	off=(uint32_t)(145+angle*2.4);
	off90 = (uint32_t)(145+90*2.4);
	off180 = (uint32_t)(145+180*2.4);
	pca_setpwm(0,0,off90);pca_setpwm(1,0,off90);pca_setpwm(2,0,off180);pca_setpwm(3,0,off);
